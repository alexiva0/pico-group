...
const Article: React.FC = () => (
  <div className={cn()}>
    ...
    <div className={cn('section')}>
      ...
      <div className={cn('image-box')}>
        <img className={cn('image')} src={Image4} alt="Scheme 4" />
        <div className={cn('image-footnote')}>Figure 3.</div>
      </div>
      <p className={cn('paragraph', { italic: true })}>[2] S. Singh, J. T. Peltonen, I. M. Khaymovich, J. V. Koski, C. Flindt, and J. P. Pekola. Distribution of current fluctuations in a bistable conductor, Phys. Rev. B <span className={cn('strong')}>94</span>, 241407(R) (2016).</p>
    </div>
  </div>
);
