...
const Article: React.FC = () => {
  ...
  return (
    <div className={cn()}>
      ...
      <div className={cn('section')}>
        <p className={cn('note')}>Last update: 19.02.2014</p>
      ...
      <Tooltip triggerElement={triggerElement2}>
        <p>[2] S. Singh, J. T. Peltonen, I. M. Khaymovich, J. V. Koski, C. Flindt, and J. P. Pekola. Distribution of current fluctuations in a bistable conductor, Phys. Rev. B <span className={cn('strong')}>94</span>, 241407(R) (2016).</p>
      </Tooltip>
    </div>
  );
};
