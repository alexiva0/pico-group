...
export const sideMenuItems = [
    ...
    },
    {
        ...
        href: '/people/former-group-members',
    },
    {
        title: 'Guestbook',
        href: '/people/guestbook',
    },
];

export const groupPeople = {
    text: 'Low Temperature Laboratory, <br /> Department of Applied Physics, <br /> Aalto University School of Science <br /> P.O. Box 13500 <br /> 00076 AALTO, Finland',
    people: [
        {
